...
```java
public class Pessoa {
    String nome;           // campo de instância (cada objeto tem sua cópia)
    static int contador;   // campo de classe (compartilhados por todos os objetos)
}
```
