...
>⚠️ Quando você escreve `cadence = 0`; **COM PONTO E VÍRGULA**, ela **deixa de ser** apenas uma **EXPRESSÃO** e passa a ser uma **DECLARAÇÃO** de expressão — ou seja, uma instrução completa que o programa executa.
